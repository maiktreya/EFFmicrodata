...
for (i in 1:5) {
    ...
    # remaining +3
    dt[[i]][, prop41 := 0][p2_42s1_4 == 1 & p2_35a_4 == 1 & p2_43_4 > 0, prop41 := 1]
    dt[[i]][, prop42 := 0][p2_42s2_4 == 1 & p2_35a_4 == 1 & p2_43_4 > 0, prop42 := 1]
    dt[[i]][, prop43 := 0][p2_42s3_4 == 1 & p2_35a_4 == 1 & p2_43_4 > 0, prop43 := 1]
    dt[[i]][, prop44 := 0][p2_42s4_4 == 1 & p2_35a_4 == 1 & p2_43_4 > 0, prop44 := 1]
    dt[[i]][, prop45 := 0][p2_42s5_4 == 1 & p2_35a_4 == 1 & p2_43_4 > 0, prop45 := 1]
